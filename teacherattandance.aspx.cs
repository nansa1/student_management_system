...
namespace student_management_system
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("teacherattandanceedit.aspx");
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Attandance where Student_id=@Id and Courseid=@cid", conn);
            ...
            if (dt.Rows.Count == 0)
            {
                try
                {
                    string Attandances = (GridView1.Rows[e.RowIndex].FindControl("txtAttandance") as TextBox).Text.Trim();
                    ...
                    {
                        con.Open();
                        string query = "INSERT INTO Attandance(Student_id,Sem,Dep,Courseid,Coursename,Attandance) VALUES (@Student_id,@Sem,@Dep,@Courseid,@Coursename,@Attandance)";
            ...
            {
                lblSuccessMessage.Text = "";
                lblErrorMessage.Text = "Attandance persent already";
            }
        }
