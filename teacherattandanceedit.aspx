<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="teacherattandanceedit.aspx.cs" Inherits="student_management_system.WebForm10" %>
        ...
        <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Attandance">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("Attandance") %>' runat="server" />
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtAttandance" Text='<%# Eval("Attandance") %>' runat="server" />
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
